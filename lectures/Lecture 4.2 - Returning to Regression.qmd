...
webr:
  ...
  resources:
    ...
    - https://raw.githubusercontent.com/andrewmacd/dkustats101spr2025s3/main/lectures/Data/auto.mpg.csv
...
auto.mpg <- read.csv("Data/auto.mpg.csv")
wages <- read.csv("Data/us.dol.wages.csv")
