...
webr:
  ...
  resources:
    ...
    - https://raw.githubusercontent.com/andrewmacd/dkustats101spr2025s3/main/lectures/Data/titanic.survival.csv
...
titanic <- read.csv("Data/titanic.survival.csv")
kc.house <- read.csv("Data/king.county.sales.recent.csv")
